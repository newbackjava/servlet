...
//insert()회원가입 기능
    public void insert(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        //jsp자바코드가 다 들어감.
        //forward로 jsp를 호출할 때 service(req, res)호출함.
        //입력값으로 req, res필요!
        //forward할 때 req, res를 전달!함.
        ...
        //컨트롤러에서 처리한 결과를 jsp에 넣어서 응답할 때
        // --> forward
        //회원가입을 하고 결과를 "회원가입 성공했습니다(jsp)" 보내고 싶음.
        rd.forward(req, res); //서버의 컨트롤러가 불렀음.
        //컨트롤러에서 처리한 결과를 보낼 필요가 없고 새로운 요청을 하라고 할때
        //--> redirect
        //회원가입 성공적으로 처리 --> 다음 작업은 로그인화면을 요청
...
//        out.println("<script>");
//
//        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demo5", "root", "");
